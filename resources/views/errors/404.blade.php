...
@section('message', __('Je peux aider à résoudre certains problèmes mais trouver cette page n’en fait pas partie. Je m’excuse pour tout problème que cela pourrait causer.'))
