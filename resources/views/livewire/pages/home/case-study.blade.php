    ...
    <section id="case_study" class="px-4 md:px-8 lg:px-10 py-30 md:py-35 lg:py-40 flex flex-col gap-15 bg-dark-primary text-white">
        ...
        <div class="flex flex-col gap-2">
            ...
            <div class="flex flex-col gap-2 md:grid md:grid-cols-2 lg:grid-cols-3">
                ...
                <div
                    class="relative p-4 lg:p-7 h-90 md:h-115 flex flex-col items-center bg-dark-secondary rounded-2xl overflow-hidden">
                ...
                @if($caseStudy->quote)
                    <div
                        class="relative p-6 lg:p-8 md:h-115 flex flex-col content-between gap-20 md:hidden lg:flex lg:gap-37.5 rounded-2xl border border-dashed border-gray-light">
                        <x-font.text-2xl>
                            "{{ $caseStudy->quote }}"
                        </x-font.text-2xl>
            ...
            @if($caseStudy->stats && count($caseStudy->stats) > 0)
                <div class="flex flex-col gap-2 md:grid md:grid-cols-4">
                    @foreach($caseStudy->stats as $stat)
                        <div
                            class="p-6 lg:p-7 h-30 md:h-45 lg:h-42 flex flex-col content-between bg-dark-secondary rounded-2xl">
