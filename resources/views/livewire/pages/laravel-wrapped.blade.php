<div>
    <section class="px-6 lg:px-10 py-12 pt-30 lg:pt-40 max-w-[1200px] mx-auto">
        ...
        <div class="relative flex flex-col items-start gap-4">
            ...
            {{-- Content --}}
            <div class="columns-1 md:columns-2 lg:columns-3 gap-x-4 lg:gap-x-6 w-full">
                ...
                >
                    <x-slot:icon>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" class="h-6 w-6 shrink-0 text-neutral-500">
                ...
                >
                    <x-slot:icon>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 shrink-0 text-neutral-500">
                ...
                >
                    ...
                    <x-slot:image>
                        <div class="relative mb-3 flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="296" height="296" viewBox="0 0 296 296" fill="none" class="h-74 w-74 shrink-0">
                ...
                >
                    <x-slot:icon>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="18" viewBox="0 0 24 18" fill="none" class="h-6 w-6 shrink-0 text-neutral-500">
                ...
                {{-- Card 7 --}}
                <x-wrapped.card-sticker :start-index="0" />
                    ...
                    <x-slot:content>
                        <div class="relative mb-3 flex items-center justify-center">
                            ...
                            <div class="absolute top-1/2 left-8 flex -translate-y-1/2 flex-col gap-2">
                                <span class="font-mono text-xl font-medium text-neutral-500">"add"</span>
                                <span class="font-mono text-xl font-medium text-neutral-500">"invoice"</span>
                                <span class="font-mono text-xl font-medium text-neutral-500">"update"</span>
                            </div>
                        </div>
                    </x-slot:content>
                </x-wrapped.card-white>
                ...
                {{-- Card finale --}}
                <x-wrapped.card-sticker :start-index="4" />
            </div>
        </div>
    </section>
