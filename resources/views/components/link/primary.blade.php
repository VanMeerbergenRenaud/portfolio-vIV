        ...
        <div class="p-4 flex gap-2 typo-link {{ $textClasses }}">
            <span class="relative p-0 h-4 md:h-4.5 overflow-hidden">
                <span class="block transition-transform duration-400 ease-in-out group-hover:-translate-y-3 md:group-hover:-translate-y-4">
                    ...
                    <span class="block origin-left transition-transform duration-400 ease-in-out rotate-[20deg] group-hover:rotate-0" aria-hidden="true">{{ $slot }}</span>
                </span>
            </span>
        </div>
        {{-- Arrow --}}
        <div class="aspect-square overflow-clip rounded-xl w-12 h-12 flex-center {{ $arrowBg }}">
            <svg class="transform -rotate-45 group-hover:rotate-0 transition-all duration-300" aria-hidden="true" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path
